...
fun String?.int(): Int = if (this.isNullOrEmpty()) 0 else this.toInt()
fun String?.long(): Long = if (this.isNullOrEmpty()) 0L else this.toLong()
fun String?.double(): Double = if (this.isNullOrEmpty()) 0.00 else this.toDouble()
fun String?.float(): Float = if (this.isNullOrEmpty()) 0f else this.toFloat()
